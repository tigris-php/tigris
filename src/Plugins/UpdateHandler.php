...
class UpdateHandler extends AbstractPlugin
{
    ...
    {
        $this->bot->addListener(UpdateEvent::EVENT_UPDATE_RECEIVED, [$this, 'onUpdateReceived']);
        $this->bot->addListener(MessageEvent::EVENT_MESSAGE_RECEIVED, [$this, 'onMessageReceived']);
    }
